pipeline {
    ...
    environment {
        ...
        APP_REPO_NAME = "comp--wolf/todo_app"
        APP_NAME = "todo"
    }
    stages {
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'Comp-Wolf', disableHostKeyChecking: true, installation: 'ansible', inventory: 'inventory_aws_ec2.yml', playbook: 'docker_project.yaml'
             }
        }
